                                ...
                                !_isSameUser ?
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          _contactBy(icon: Icons.email, color: Colors.blue, fct: (){
                                            _mailTo();
                                          }),
                                          _contactBy(icon: FontAwesome.whatsapp, color: Colors.green, fct: (){
                                            _openWhatsappChat();
                                          }),
                                          _contactBy(icon: Icons.phone, color: Colors.red, fct: (){
                                            _callPhoneNumber();
                                          }),
                                        ],
                                      ),
